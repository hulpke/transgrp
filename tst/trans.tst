...
# NrTransitiveGroups
#
gap> List([2..31],NrTransitiveGroups);
[ 1, 2, 5, 5, 16, 7, 50, 34, 45, 8, 301, 9, 63, 104, 1954, 10, 983, 8, 1117, 
  164, 59, 7, 25000, 211, 96, 2392, 1854, 8, 5712, 12 ]
gap> List([33..47],NrTransitiveGroups);
[ 162, 115, 407, 121279, 11, 76, 306, 315842, 10, 9491, 10, 2113, 10923, 56, 
  6 ]
...
>   od;
> od;
gap> g:=List(Difference([10..47],[32]),x->TransitiveGroup(x,Int(2/3*NrTransitiveGroups(x))));;
gap> List(g,Size);
[ 720, 660, 1152, 156, 2688, 14580, 1536, 4080, 26244, 171, 80000, 222264, 
  ...
  119750400, 8912896, 1306912320, 169869312, 444, 9961472, 6908733, 
